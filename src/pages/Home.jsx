...
import heroImage4 from "../assets/hero-slider-4.png";
...
function HeroSlider() {
    const slides = [
        ...
        { src: heroImage4, alt: "SB Enterprises promotional " },
    ];
        ...
        <div>
            ...
            <section className="relative overflow-hidden">
                ...
                <Container className="py-14 sm:py-20">
                    <div className=" flex flex-col-reverse gap-10 lg:grid lg:grid-cols-2 lg:items-center lg:flex-row ">
                        <div className="">
                            <Reveal>
